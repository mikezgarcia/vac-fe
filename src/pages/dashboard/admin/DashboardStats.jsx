    ...
    <>
      <div className="flex flex-col items-center md:flex-row md:justify-around h-2/3 mt-4">
        ...
        <div className="stat-card mt-2">
          ...
          <div className="flex flex-row items-center">
            ...
            <h2 className="stat-title font-bold">Total Savings</h2>
          </div>
          {/* End Icon - Title */}
          {/* Main Text */}
        ...
        <div className="stat-card mt-2">
          ...
          <div className="flex flex-row items-center">
            ...
            <h2 className="stat-title font-bold">Total Withdrawn</h2>
          </div>
          {/* End Icon - Title */}
          {/* Main Text */}
      ...
      <div className="flex flex-col items-center md:flex-row md:justify-around h-2/3 mt-4">
        ...
        <div className="stat-card mt-2">
          ...
          {/* End Icon - Title */}
          {/* Main Text */}
          <h1 className="stat-figure mb-10 text-5xl">2,543,981</h1>
        </div>
        {/* End Cash In Stats */}
